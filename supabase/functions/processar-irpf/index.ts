    ...
    if (declaracaoExistente) {
      const { data: declAtualizada, error: declError } = await supabase
        ...
        .update({
          ...
          telefone_ddd: irpfData.endereco?.telefoneDdd,
          telefone_numero: irpfData.endereco?.telefoneNumero,
          celular_ddd: irpfData.endereco?.celularDdd,
          celular_numero: irpfData.endereco?.celularNumero,
          natureza_ocupacao_codigo: irpfData.ocupacao?.naturezaCodigo,
          natureza_ocupacao_descricao: irpfData.ocupacao?.naturezaDescricao,
          ocupacao_principal_codigo: irpfData.ocupacao?.ocupacaoCodigo,
          ocupacao_principal_descricao: irpfData.ocupacao?.ocupacaoDescricao,
