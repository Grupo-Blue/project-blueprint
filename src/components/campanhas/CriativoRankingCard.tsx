            ...
            {etapasFunil.map(e => {
              ...
              return (
                <div key={e.label} className="flex items-center gap-1.5">
                  <span className="text-[10px] text-muted-foreground w-8 text-right flex-shrink-0">{e.label}</span>
                  ...
                  <span className="text-[10px] font-medium w-10 text-right flex-shrink-0">
