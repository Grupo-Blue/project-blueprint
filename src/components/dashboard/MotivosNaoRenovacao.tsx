...
const CORES = ["#ef4444", "#f59e0b", "#06b6d4", "#8b5cf6", "#ec4899", "#14b8a6", "#6366f1"];

export function MotivosNaoRenovacao() {
  ...
  const { data: motivos } = useQuery({
    queryKey: ["motivos-nao-renovacao", empresaSelecionada, dataInicio, dataFim],
    queryFn: async () => {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg">Motivos de Não Renovação</CardTitle>
      </CardHeader>
      <CardContent>
