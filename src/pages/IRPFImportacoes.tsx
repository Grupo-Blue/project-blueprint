...
import { Upload, FileText, Eye, Users, Building2, Bitcoin, TrendingUp, AlertCircle, CheckCircle, Clock, Loader2 } from "lucide-react";
...
export default function IRPFImportacoes() {
  ...
  const stats = {
    ...
    comCripto: declaracoes?.filter(d => 
      bensDeclaracao?.some(b => b.grupo_codigo === '08')
    ).length || 0,
  };
  ...
  return (
    <div className="p-6 space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-2xl font-bold">
                  {declaracoes?.filter(d => d.id_lead).length || 0}
                </p>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Declarações Importadas</CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-10 text-muted-foreground">
              ...
              <p>Nenhuma declaração importada ainda</p>
                                  ...
                                  {dividasDeclaracao?.map((divida) => (
                                    <Card key={divida.id}>
                                      <CardContent className="pt-4">
                                        <div className="flex items-start justify-between mb-2">
                                          <div className="flex items-center gap-2">
                                            ...
                                            <Badge variant="outline" className="text-red-600">
                                              {divida.codigo_descricao || `Código ${divida.codigo}`}
                                            </Badge>
                                          </div>
                                          <div className="text-right">
                                        ...
                                        {divida.credor_nome && (
                                          <p className="text-sm mb-2">
                                            <strong>Credor:</strong> {divida.credor_nome}
                                          </p>
                                        )}
